...
<div class="DashboardNavigation Scroll">
	<ul>
		<li><a data-toggle="collapse" data-target="#NavCollapase" href="javascript:void(0)"><img src="<?php echo base_url('assets/frontend/');?>/images/speedometer.svg" alt="Icon" /> Dashboard <i class="fa fa-angle-up" aria-hidden="true"></i></a>
			<div id="NavCollapase" class="collapse show">
		...
		<li><a href="<?php echo base_url('refund-overview') ?>"><img src="<?php echo base_url('assets/frontend/');?>/images/money-back.svg" alt="Icon" /> Refunds</a>
		</li>
		...
		<li class="Logout"><a href="javascript:void(0)"><img src="<?php echo base_url('assets/frontend/');?>/images/exit.svg" alt="Icon" /> Logout</a></li>
	</ul>
</div>